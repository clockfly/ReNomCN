from renom_cn.db import connector
...
class TestSQLite(object):
    ...
    def setup_class(self):
        ...
        self.conn = connector.SQLiteConnector()
...
class TestMySQL(object):
    ...
    def setup_class(self):
        ...
        database = "testdb"
        self.conn = connector.MySQLConnector(host, port, user, password, database)
        create_table(self.conn)
...
class TestPostgreSQL(object):
    ...
    def setup_class(self):
        ...
        password = "testpassword"
        database = "testdb"
        self.conn = connector.PostgreSQLConnector(host, port, user, password, database)
        create_table(self.conn)
